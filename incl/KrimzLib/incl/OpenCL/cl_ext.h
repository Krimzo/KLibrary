...
typedef enum _cl_semaphore_handle_type__enum {
    ...
    // Any addtional API-specific semaphore handle types 
    // to be specified by respective API specific spec.
...
//typedef enum _cl_external_context_type_enum cl_external_context_type;
...
typedef enum _cl_external_mem_handle_type_enum {
    ...
    // API-specific memory handle types to be specified by API specific spec.
