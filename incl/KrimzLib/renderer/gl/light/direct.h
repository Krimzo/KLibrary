...
namespace kl {
	namespace gl {
		struct direct {
			...
			void genBuff(int mapSize) {
				if (!depthFB) {
					...
					depth_sha = new kl::gl::shaders(vertSource, fragSource);
		...
		private:
			...
			// Shadow shaders
			kl::gl::shaders* depth_sha = nullptr;
	...
	std::string kl::gl::direct::vertSource = R"(
		#version 330
	...
	std::string kl::gl::direct::fragSource = R"(
		#version 330
