...
int examples::raster_example_main(int argc, char** argv)
{
    ...
    window.on_resize.emplace_back([&](int2 size) {
        ...
        gpu.raster_batch.emplace_back(
            new kl::RasterRectangle{float2{0.0f, 0.75f}, float2{0.5f, 0.5f}, kl::colors::CRIMSON, false});
        gpu.raster_batch.emplace_back(
            new kl::RasterRectangle{float2{0.5f, 0.5f}, float2{0.75f, 0.25f}, kl::colors::SKY, true, {25.0f, 25.0f}});
        gpu.raster_batch.emplace_back(new kl::RasterEllipse{float2{0.0f, 0.0f}, float2{0.5f * size.y / size.x, 0.5f},
                                                            kl::colors::WHEAT, false, 2.0f});
        gpu.raster_batch.emplace_back(
            new kl::RasterEllipse{float2{-0.5f, -0.5f}, float2{0.5f * size.y / size.x, 0.5f}, kl::colors::WHITE, true});
    });
