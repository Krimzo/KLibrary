...
void kl::gl::resetViewport(HWND hwnd) {
	RECT clientArea = {};
...
void kl::gl::setDepthTest(bool enabled) {
	if (enabled) {
...
void kl::gl::setWireframe(bool enabled) {
	if (enabled) {
...
void kl::gl::clearBuffers(const kl::vec3& color) {
