...
struct HttpContentType
{
    ...
    static constexpr std::string_view VND_OASIS_OPENDOCUMENT_SPREADSHEET =
        "application/vnd.oasis.opendocument.spreadsheet";
    static constexpr std::string_view VND_OASIS_OPENDOCUMENT_PRESENTATION =
    ...
    static constexpr std::string_view VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_SHEET =
        "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
    static constexpr std::string_view VND_MS_POWERPOINT = "application/vnd.ms-powerpoint";
    static constexpr std::string_view VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_PRESENTATION =
        "application/vnd.openxmlformats-officedocument.presentationml.presentation";
    static constexpr std::string_view MSWORD = "application/msword";
    static constexpr std::string_view VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_DOCUMENT =
...
struct HttpResponse
{
    ...
    template <typename... Args> void load(Args&&... args)
    {
