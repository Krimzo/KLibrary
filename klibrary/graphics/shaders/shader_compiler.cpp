...
kl::CompiledShader kl::ShaderCompiler::compile(std::string_view const& name, std::string_view const& version,
...
kl::CompiledShader kl::ShaderCompiler::compile_vertex_shader(std::string_view const& source,
                                                             std::string* out_error) const
{
    return compile("v_shader", "vs_5_0", source, out_error);
}

kl::CompiledShader kl::ShaderCompiler::compile_geometry_shader(std::string_view const& source,
                                                               std::string* out_error) const
{
    return compile("g_shader", "gs_5_0", source, out_error);
}

kl::CompiledShader kl::ShaderCompiler::compile_pixel_shader(std::string_view const& source,
                                                            std::string* out_error) const
{
    return compile("p_shader", "ps_5_0", source, out_error);
}

kl::CompiledShader kl::ShaderCompiler::compile_compute_shader(std::string_view const& source,
                                                              std::string* out_error) const
{
