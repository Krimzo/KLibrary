...
static void transform_context( SHA256Context& context, uint8_t const* data )
{
...
static void update_context( SHA256Context& context, uint8_t const* data, uint64_t data_size )
{
