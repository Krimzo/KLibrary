...
kl::Encryptor::Encryptor( int key_count )
{
...
void kl::Encryptor::run_pass( void* data, uint64_t byte_size ) const
{
    for ( auto& key : keys )
    {
...
std::ostream& kl::operator<<( std::ostream& stream, Encryptor const& encryptor )
{
