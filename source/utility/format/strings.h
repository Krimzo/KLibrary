...
namespace kl
{
template <int W, int H, typename T> constexpr std::string format_matrix(T const* data)
{
...
namespace kl
{
template <bool NewLine = true, typename... Args> void write(std::ostream& stream, Args&&... args)
{
...
template <bool NewLine = true, typename... Args> void print(Args&&... args)
{
...
template <bool NewLine = true, typename... Args> void write(std::wostream& w_stream, Args&&... args)
{
...
template <bool NewLine = true, typename... Args> void wprint(Args&&... args)
{
    write<NewLine>(std::wcout, args...);
}

template <typename... Args> std::wstring wformat(Args&&... args)
{
