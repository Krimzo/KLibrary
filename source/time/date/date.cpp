...
{
    stream << std::setfill('0') << std::setw(4) << obj.year << '.' << std::setw(2) << obj.month << '.' << std::setw(2)
           << obj.day << ' ' << std::setw(2) << obj.hour << ':' << std::setw(2) << obj.minute << ':' << std::setw(2)
           << obj.second << '.' << std::setw(3) << obj.milisecond;
    return stream;
}
