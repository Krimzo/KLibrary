...
struct GPU12Commands
{
    ...
    void set_render_target(dx12::DescriptorHandle const* render_target,
                           dx12::DescriptorHandle const* depth_target) const;
    void draw(UINT vertex_count, UINT instance_count = 1) const;

    void update_tlas(dx12::AccelerationStructure const& tlas, dx12::AccelerationStructure const& tlas_update_scratch,
