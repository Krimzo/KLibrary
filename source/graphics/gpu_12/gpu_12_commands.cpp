...
kl::GPU12Commands::GPU12Commands(dx12::CommandAllocator const& allocator) : allocator(allocator)
{
}
...
void kl::GPU12Commands::transition_resource(dx12::Resource const& resource, D3D12_RESOURCE_STATES from,
...
void kl::GPU12Commands::clear_target_view(dx12::DescriptorHandle const& handle, float4 color) const
{
...
void kl::GPU12Commands::set_render_target(dx12::DescriptorHandle const* render_target,
                                          dx12::DescriptorHandle const* depth_target) const
{
...
void kl::GPU12Commands::update_tlas(dx12::AccelerationStructure const& tlas,
                                    dx12::AccelerationStructure const& tlas_update_scratch,
                                    dx12::Resource const& instances) const
{
