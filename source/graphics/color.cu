...
// Constructors
ALL kl::color::color() : b(0), g(0), r(0), a(0) {}
ALL kl::color::color(byte r, byte g, byte b, byte a) : b(b), g(g), r(r), a(a) {}

// Operator overloading
ALL bool kl::color::equ(const kl::color& obj) const {
	return r == obj.r && g == obj.g && b == obj.b && a == obj.a;
}
ALL bool kl::color::operator==(const kl::color& obj) const {
	return equ(obj);
}
ALL bool kl::color::operator!=(const kl::color& obj) const {
	return !equ(obj);
...
ALL kl::color kl::color::mix(const kl::color& col) const {
