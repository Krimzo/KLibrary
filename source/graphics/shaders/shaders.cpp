...
kl::CBuffer::CBuffer(GPU const* gpu) : gpu(gpu)
{
}
...
void kl::CBuffer::bind(ShaderType type, int index) const
{
    ...
    case ShaderType::VERTEX:
        gpu->bind_cb_for_vertex_shader(cbuffer, index);
        break;
    case ShaderType::PIXEL:
        gpu->bind_cb_for_pixel_shader(cbuffer, index);
        break;
    case ShaderType::GEOMETRY:
        gpu->bind_cb_for_geometry_shader(cbuffer, index);
        break;
    case ShaderType::COMPUTE:
        gpu->bind_cb_for_compute_shader(cbuffer, index);
        break;
    }
}

kl::Shaders::Shaders(GPU const* gpu) : CBuffer(gpu)
{
}
