...
namespace kl {
	...
	public:
		...
		void setCBufferData(kl::dx::buffer m_Buffer, const void* data);
		void bindVertexCBuffer(kl::dx::buffer m_Buffer, uint slot);
		void bindPixelCBuffer(kl::dx::buffer m_Buffer, uint slot);
