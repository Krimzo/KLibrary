...
kl::json::Array::Array(std::initializer_list<ArrayStorage::value_type> const& items) : ArrayStorage(items)
{
}

kl::json::Array::Array(std::string_view data)
{
...
std::string kl::json::Array::decompile(int depth) const
{
    if (empty())
