...
struct Container
{
    ...
    virtual std::optional<bool> get_bool() const
    {
        return std::nullopt;
    }
    ...
    virtual std::optional<double> get_double() const
    {
        return std::nullopt;
    }
    virtual std::optional<float> get_float() const
    {
        return std::nullopt;
    }
    virtual std::optional<int64_t> get_long() const
    {
        return std::nullopt;
    }
    virtual std::optional<int32_t> get_int() const
    {
        return std::nullopt;
    }
    virtual std::optional<int16_t> get_short() const
    {
        return std::nullopt;
    }
    virtual std::optional<uint8_t> get_byte() const
    {
        return std::nullopt;
    }
